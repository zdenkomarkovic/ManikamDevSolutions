          ...
          <div>
            ...
            <div className="space-y-3 mb-6">
              <div className="flex items-start">
                ...
                <span>
                  {intl.formatMessage({
                    id: "websiteDevelopment.packages.basic.feature1",
                  })}
                </span>
              </div>
              <div className="flex items-start">
                ...
                <span>
                  {intl.formatMessage({
                    id: "websiteDevelopment.packages.basic.feature2",
                  })}
                </span>
              </div>
              <div className="flex items-start">
                ...
                <span>
                  {intl.formatMessage({
                    id: "websiteDevelopment.packages.basic.feature3",
                  })}
                </span>
              </div>
              <div className="flex items-start">
                ...
                <span>
                  {intl.formatMessage({
                    id: "websiteDevelopment.packages.basic.feature4",
                  })}
                </span>
              </div>
              <div className="flex items-start">
                ...
                <span>
                  {intl.formatMessage({
                    id: "websiteDevelopment.packages.basic.feature5",
                  })}
                </span>
              </div>
              <div className="flex items-start">
                ...
                <span>
                  {intl.formatMessage({
                    id: "websiteDevelopment.packages.basic.feature6",
                  })}
                </span>
              </div>
              <div className="flex items-start">
                ...
                <span>
                  {intl.formatMessage({
                    id: "websiteDevelopment.packages.basic.feature7",
                  })}
                </span>
              </div>
            </div>
        ...
        >
          <div className="absolute top-0 right-0 bg-gradient-to-r from-orange-600 to-orange-400 text-white px-4 py-1 rounded-bl-2xl text-xs">
            <span className="font-bold">
              {intl.formatMessage({
                id: "websiteDevelopment.packages.professional.badge",
              })}
            </span>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3 mb-6">
              <div className="flex items-start">
                ...
                <span>
                  {intl.formatMessage({
                    id: "websiteDevelopment.packages.professional.feature1",
                  })}
                </span>
              </div>
              <div className="flex items-start">
                ...
                <span>
                  {intl.formatMessage({
                    id: "websiteDevelopment.packages.professional.feature2",
                  })}
                </span>
              </div>
              <div className="flex items-start">
                ...
                <span>
                  {intl.formatMessage({
                    id: "websiteDevelopment.packages.professional.feature3",
                  })}
                </span>
              </div>
              <div className="flex items-start">
                ...
                <span>
                  {intl.formatMessage({
                    id: "websiteDevelopment.packages.professional.feature4",
                  })}
                </span>
              </div>
              <div className="flex items-start">
                ...
                <span>
                  {intl.formatMessage({
                    id: "websiteDevelopment.packages.professional.feature5",
                  })}
                </span>
              </div>
              <div className="flex items-start">
                ...
                <span>
                  {intl.formatMessage({
                    id: "websiteDevelopment.packages.professional.feature6",
                  })}
                </span>
              </div>
              <div className="flex items-start">
                ...
                <span>
                  {intl.formatMessage({
                    id: "websiteDevelopment.packages.professional.feature7",
                  })}
                </span>
              </div>
              <div className="flex items-start">
                ...
                <span>
                  {intl.formatMessage({
                    id: "websiteDevelopment.packages.professional.feature8",
                  })}
                </span>
              </div>
            </div>
          ...
          <div>
            ...
            <div className="space-y-3 mb-6">
              <div className="flex items-start">
                ...
                <span>
                  {intl.formatMessage({
                    id: "websiteDevelopment.packages.premium.feature1",
                  })}
                </span>
              </div>
              <div className="flex items-start">
                ...
                <span>
                  {intl.formatMessage({
                    id: "websiteDevelopment.packages.premium.feature2",
                  })}
                </span>
              </div>
              <div className="flex items-start">
                ...
                <span>
                  {intl.formatMessage({
                    id: "websiteDevelopment.packages.premium.feature3",
                  })}
                </span>
              </div>
              <div className="flex items-start">
                ...
                <span>
                  {intl.formatMessage({
                    id: "websiteDevelopment.packages.premium.feature4",
                  })}
                </span>
              </div>
              <div className="flex items-start">
                ...
                <span>
                  {intl.formatMessage({
                    id: "websiteDevelopment.packages.premium.feature5",
                  })}
                </span>
              </div>
              <div className="flex items-start">
                ...
                <span>
                  {intl.formatMessage({
                    id: "websiteDevelopment.packages.premium.feature6",
                  })}
                </span>
              </div>
              <div className="flex items-start">
                ...
                <span>
                  {intl.formatMessage({
                    id: "websiteDevelopment.packages.premium.feature7",
                  })}
                </span>
              </div>
              <div className="flex items-start">
                ...
                <span>
                  {intl.formatMessage({
                    id: "websiteDevelopment.packages.premium.feature8",
                  })}
                </span>
              </div>
              <div className="flex items-start">
                ...
                <span>
                  {intl.formatMessage({
                    id: "websiteDevelopment.packages.premium.feature9",
                  })}
                </span>
              </div>
            </div>

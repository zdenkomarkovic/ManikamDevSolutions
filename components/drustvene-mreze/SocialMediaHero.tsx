  ...
  return (
    <div className="container mx-auto text-center">
      ...
      <p className="text-base md:text-2xl text-gray-100 mb-5 md:mb-8 max-w-4xl mx-auto md:leading-relaxed">
        Profesionalno upravljanje Facebook i Instagram profilima. Kreiramo
        sadržaj koji privlači, oglašavamo vaš brend i gradimo lojalnu zajednicu
        oko vašeg biznisa. Povećajte angažman, doseg i prodaju preko društvenih
        mreža.
      </p>

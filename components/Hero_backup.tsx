...
const Hero = ({ title }: HeroProps) => {
  return (
    <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-white dark:bg-neutral-950">
      <div className="container mx-auto px-[5px] md:px-4 h-screen flex items-end">
        <div className="">
          <h1 className="pl-14  mb-14 relative text-gray-900 mt-[250px] md:mt-0 text-[33px] md:text-6xl xl:text-[80px] z-20">

  ...
  return (
    <div className="mt-16 bg-gradient-to-br from-gray-900 via-gray-700 to-orange-500 rounded-2xl p-4 md:p-8 shadow-lg border border-gray-100">
      ...
      >
        ...
        Bez obzira na vašu industriju ili cilj, imamo rešenje koje će doneti maksimalne rezultate.
      </motion.p>
      <motion.div 
      ...
      >
        ...
        >
          ...
          <p className="text-gray-600">
            Pojavite se na vrhu Google pretrage kada klijenti traže vaše proizvode. 
            Optimizovane kampanje za maksimalnu konverziju uz minimalan trošak.
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="text-gray-600">
            Savršeno rešenje za online prodavnice. Proizvodi se prikazuju direktno 
            u Google pretrazi sa slikom, cenom i nazivom.
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="text-gray-600">
            Ponovo dosegnite posetioce koji nisu izvršili kupovinu. Personalizovane 
            poruke za različite segmente sa većom stopom konverzije.
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="text-gray-600">
            Najnoviji tip kampanje koji koristi AI za optimizaciju kroz sve Google 
            kanale. Maksimalni doseg i performanse u jednoj kampanji.
          </p>
        </motion.div>

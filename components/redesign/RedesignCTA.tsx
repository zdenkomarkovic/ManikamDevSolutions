      ...
      <div className="max-w-5xl mx-auto">
            ...
            <div>
              ...
              <ul className="space-y-4 mb-8">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-gray-700">
                    Detaljna analiza vašeg trenutnog sajta
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-6 h-6 text-green-500 flex-shrink-0 mt-1" />
                  <span className="text-gray-700">
                    Procena performansi i SEO metrike
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-6 h-6 text-green-500 flex-shrink-0 mt-1" />
                  <span className="text-gray-700">
                    Personalizovana strategija migracije
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-6 h-6 text-green-500 flex-shrink-0 mt-1" />
                  <span className="text-gray-700">
                    Projekcija poboljšanja i ROI
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-6 h-6 text-green-500 flex-shrink-0 mt-1" />
                  <span className="text-gray-700">
                    Tačan timeline i procena troškova
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-6 h-6 text-green-500 flex-shrink-0 mt-1" />
              ...
              <div className="bg-orange-50 p-6 rounded-lg border border-orange-200">
                ...
                <p className="text-gray-700 mb-4">
                  Zakažite konsultaciju u narednih 7 dana i dobijte{" "}
                  <span className="font-bold text-orange-600">10% popusta</span>{" "}
                  na ukupnu cenu projekta + besplatnu SEO audit vrednosti €500.
                </p>
        ...
        >
          <p className="text-lg mb-4">
            Pridružite se desetinama zadovoljnih klijenata koji su modernizovali
            svoje sajtove
          </p>

...
export default function RedesignIntro() {
  ...
  return (
    ...
    >
      <motion.h2
        className="text-xl md:text-3xl font-extrabold mb-6 bg-gradient-to-r from-orange-500 to-orange-300 bg-clip-text text-transparent text-center"
      ...
      >
        ...
        >
          <div className="bg-gradient-to-br from-orange-50 to-white p-6 md:p-8 rounded-lg border border-orange-100">
            <h3 className="text-xl md:text-2xl font-bold mb-6 text-orange-600">Problemi Starih Platformi</h3>
          ...
          <div className="bg-gradient-to-br from-green-50 to-white p-6 md:p-8 rounded-lg border border-green-100">
            <h3 className="text-xl md:text-2xl font-bold mb-6 text-green-600">Prednosti Next.js Migracije</h3>
            <ul className="space-y-4">
              <li className="flex items-start gap-3">

    ...
    <div className="container mx-auto text-center">
      ...
      <div className="flex flex-wrap justify-center gap-4">
        <span className="bg-gradient-to-br from-gray-300 via-gray-100 to-gray-300 px-4 py-2 rounded-full text-xs md:text-sm font-semibold">
          {intl.formatMessage({ id: "webshopDevelopment.hero.badge1" })}
        </span>
        <span className="bg-gradient-to-br from-gray-300 via-gray-100 to-gray-300 px-4 py-2 rounded-full text-xs md:text-sm font-semibold">
          {intl.formatMessage({ id: "webshopDevelopment.hero.badge2" })}
        </span>
        <span className="bg-gradient-to-br from-gray-300 via-gray-100 to-gray-300 px-4 py-2 rounded-full text-xs md:text-sm font-semibold">
          {intl.formatMessage({ id: "webshopDevelopment.hero.badge3" })}
        </span>
      </div>
    </div>
  );

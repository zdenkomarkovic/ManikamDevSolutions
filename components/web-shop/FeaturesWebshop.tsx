  ...
  return (
    <div className="mt-16 bg-gradient-to-br from-gray-900 via-gray-700 to-orange-500 rounded-2xl p-8 shadow-lg border border-gray-100">
      ...
      <p className="text-center text-gray-100 mb-12 max-w-3xl mx-auto">
        Naša platforma obuhvata sve što vam je potrebno za uspešan online biznis.
        Svaka funkcionalnost je pažljivo dizajnirana da pruži najbolje iskustvo
        kako vama tako i vašim kupcima.
      </p>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div className="p-6 bg-gradient-to-bl from-gray-300 via-gray-100 to-gray-300 rounded-xl hover:shadow-lg transition-shadow">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h3 className="text-lg font-bold bg-gradient-to-r from-orange-500 to-orange-300 bg-clip-text text-transparent">
              Katalog Proizvoda
            </h3>
          </div>
        ...
        <div className="p-6 bg-gradient-to-bl from-gray-300 via-gray-100 to-gray-300 rounded-xl hover:shadow-lg transition-shadow">
          <div className="flex items-center gap-3 mb-2">
            <FaMobile className="text-2xl text-orange-500" />
            <h3 className="text-lg font-bold bg-gradient-to-r from-orange-500 to-orange-300 bg-clip-text text-transparent">
              Mobilna Aplikacija
            </h3>
          </div>
